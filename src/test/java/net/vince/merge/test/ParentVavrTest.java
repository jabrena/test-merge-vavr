...
public class ParentVavrTest {
  ...
  void test() throws Exception {
    ...
    //When
    var parentObject = mapper.readerFor(ParentVavr.class).readValue(parent);
    var updated = mapper.readerForUpdating(parentObject).readValue(toMerge);
    var expectedObject = mapper.readerFor(ParentVavr.class).readValue(expected);
